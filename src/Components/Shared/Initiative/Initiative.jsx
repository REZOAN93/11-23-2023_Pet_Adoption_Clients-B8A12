...
const Initiative = () => {
    return (
        <div className=' grid grid-cols-2 gap-5 max-w-6xl mx-auto mb-10'>
            <div >
                <p className=' text-4xl font-bold text-[#4aeaf8] '>Paws For Thought: <br /> Camden Council’s Latest <br /> Initiative</p>
            ...
            <div>
                <img className=' w-full' src="https://res.cloudinary.com/petrescue/image/upload/c_crop,g_custom/v1698636781/o3l1kd1jlmryg3ujwpmv.jpg" alt="" />
            </div>
        </div>
    );
};
